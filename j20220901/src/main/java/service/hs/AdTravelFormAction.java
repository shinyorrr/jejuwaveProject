...
public class AdTravelFormAction implements CommandProcess {

	@Override
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("AdTravelFormAction service start...");
		AdminDao ad = AdminDao.getInstance();
		try {
			int totCnt = ad.getTravelCnt();
			...
			List<Travel> list = ad.travelList(startRow, endRow);
