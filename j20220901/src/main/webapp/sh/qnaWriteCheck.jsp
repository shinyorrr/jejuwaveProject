...
<body>
	...
	<div class="gubun">
		<div>
			<br> <br> <span class="wait">상태</span> <span
				class="fw-bold me-2">${board.b_success }</span> <span class="wait">테마</span>             <!--  현지수정 -->
	...
	<div class="tag1">                                                                                      <!--  현지수정 -->
		...
		<div>
			<p>
				<b style="color: rgb(225, 53, 0);">2</b>개의 답변
			</p>
		</div>
	...
	<div class="content" style="margin-left: 350px">
		<form action="qnaCommentWrite.do" style="width: 2000px">
			...
			<input type="submit" value="등록"
				style="vertical-align: middle; width: 120px; height: 90px; background-color: #FF3500; border-color: #FF3500; color: white; border-radius: 10%;">
		</form>
	</div>
