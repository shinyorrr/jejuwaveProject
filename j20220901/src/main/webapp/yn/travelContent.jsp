	...
	<div class="row justify-content-center">
		...
		<div class="col-lg-9 justify-content-start">
			...
			<article class="mb-5 pb-3">
				<!-- 게시물 이미지 -->
				<figure class="mb-4">
					<img class="img-fluid rounded mb-5" src="../yn_images/jejuSea04.jpg" style="width:100%; height:250px; object-fit:cover;">
				</figure>
					<!-- 글제목 -->
				 <header class="mb-3">
					<p name="t_title" class="h4 fw-bold mb-2">${travel.t_title}</p>
					<!--작성일 -->
						<p  id="dateViwer" class="text-muted m-0 form-check-inline align-center">${travel.t_date}</span> &nbsp&nbsp&#183 &nbsp
						<button  type="button" id="dateViwer" class="btn p-0  m-0 text-muted">수정</button>&#183&nbsp
				...
				<div class=" form-group row my-5  ">
					...
					<div class="card py-2 inline col-lg-9 justify-content-start floatLL ms-3">
						<div class="card-body ">
							<p class="mb-2"><span id="keyColor" class="fw-bold me-2">${travel.t_gubun}</span>모집 인원 ${travel.t_person}명</p>
							<div>
								...
								<span class="mt-1">${travel.t_start}&nbsp~&nbsp${travel.t_end}</span>
							</div>
						</div>
					</div>
					<!-- 사이드 바 메뉴 동행 후기 보기-->
					<div class="panel panel-info border justify-content-end floatRR col-lg-2 ms-3 p-3 align-middle" id="userBox">
						<div class="card-body mb-0 p-0">
							...
							<span name="user_id" class="h5">${travel.user_id}</span>
