	...
	<div class="row justify-content-center">
		<div class="col-lg-9 justify-content-start">
						...
						<article class="mb-5 pb-3">
							<!-- 게시물 이미지 -->
							<figure class="mb-4">
								<img class="img-fluid rounded mb-4" src="yn_images/upload/${travelContent.t_img}" style="width:100%; height:280px; object-fit:cover;">
							</figure>
							...
							<!-- 글제목 -->
						 	<header class="mb-3">
								...
								<p  id="dateViwer" class="text-muted m-0 form-check-inline align-center">${travelContent.t_date}</span> 
									...
									<button onclick="location.href='travelDelete.do?t_num=${travelContent.t_num}&t_ref=${travelContent.t_ref}'" id="dateViwer" type="button" class="btn p-0 text-muted">&nbsp&nbsp&#183&nbsp&nbsp삭제</button>
							...
							<div class="card bg-light card-body my-4 p-4 border-0">
								...
								<input name="t_relevel" type="hidden" value="1">
									...
									<div class="input-group my-3">
										...
										<textarea name="t_content" rows="2" class="form-control p-1" style=" border-left:none;" placeholder="댓글을 남겨 보세요!" aria-label="Input group example" aria-describedby="basic-addon1"></textarea>
									</div>
								</form>
								<!-- 구분 라인 --> 
								...
								<div class="d-flex mb-4 pt-3">
									<div class="flex-shrink-0 ms-5 align-middle">
										...
										<c:choose>
											<c:when test="${reply.user_id eq travelContent.user_id}">
												<img src="yn_images/user_icon04.png"  width="42" height="42" class=" bg-white userIconColor-1 rounded-circle me-2 mt-1 ">
												</c:when>
											<c:otherwise>
												<img src="yn_images/user_icon01.png"  width="42" height="42" class=" bg-white userIconColor-1 rounded-circle me-2 mt-1 ">
											</c:otherwise>
										</c:choose>
									</div>
									...
									<div class="mb-2" style="display: flex;">
										...
										<span style="color:#8C8C8C;">${reply.t_date} </span>
									 	<button  
												data-bs-toggle="collapse" data-bs-target="#reply${reply.t_num}" 
												style="margin-left:50px; font-size: 85%; color:#8C8C8C;">댓글 달기</button>
												
												
										<c:if test="${reply.user_id eq userId}">
											<button onclick="location.href='travelDelete.do?t_num=${reply.t_num}&t_ref=${reply.t_ref}'" 
