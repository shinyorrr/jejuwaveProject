...
<header class="py-5 mb-5"
	style="background-image: url('../yn_images/travelerList_cate.jpg'); background-size: cover; margin-top: 73px;">
		...
		<div class="col-lg-6 col-sm-12 text-lg-start">
			<form action="#" class=" form-inline">
				...
				<div class="col-lg-5 text-lg-start" style="width: 240px;">
					<input name="t_start" type="text" class="form-control me-2"
						id="input_from" placeholder="시작 날짜">
				</div>
				-
				<div class="col-lg-5 text-lg-end" style="width: 240px;">
					<input name="t_end" type="text" class="form-control ms-4"
						id="input_to" placeholder="종료 날짜">
				</div>
			</form>
		</div>
		...
		<div class="row gx-4 gx-lg-3 row-cols-2 row-cols-md-3 row-cols-xl-4 ">
			<c:if test="${totCnt > 0}">
				<c:forEach var="travel" items="${travelList}">
					...
					<c:if test="${travel.t_title != null}">
						<div class="col mb-5">
							<div class="card h-70">
								<!-- Content image-->
								<div id="pic">
									<img class="card-img-top" src="<%=context%>/${travel.t_img}"
										alt="jeju-img" />
								...
								<div class="card-body p-4">
									<div class="text-left">
										...
										<p class="fw-bolder" id="title">
											<b style="color: #ff3500;">모집중</b>&nbsp&nbsp <span>${travel.t_title}</span>
										</p>
										<p id="content">${travel.t_content}</p>
										<p id="IdComment">
											<img src="../yn_images/user_icon01.png" width="20" height="20" style= "margin: 0 5px 6px 0;" class="userIconColor-1 rounded-circle me-2  align-center border-2 border-secondary">
											 ${travel.user_id}
											 
											 <span id="comment"> <img style="width: 16px; height: 16px;"
